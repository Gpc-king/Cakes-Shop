                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <ul class="multi-column-dropdown">
                                            ...
                                            <%
                                                TypeService typeService=new TypeService();//获取typeservice)对象
                                                List<Type> types=typeService.GetAllType();//通过typeService.GetAl.1Type()方法，获取所有类型
                                                request.setAttribute("typeList",types);//将typeList放入范围
